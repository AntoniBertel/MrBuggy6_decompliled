...
// Type: MrBuggy6.Core.ManagerConnectionChangeStatusEvent
...
{
  public delegate void ManagerConnectionChangeStatusEvent(object sender, ConnetcionStatus connectionStatus);
}
