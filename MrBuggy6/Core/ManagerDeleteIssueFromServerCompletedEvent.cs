...
// Type: MrBuggy6.Core.ManagerDeleteIssueFromServerCompletedEvent
...
{
  public delegate void ManagerDeleteIssueFromServerCompletedEvent(object sender, bool success);
}
