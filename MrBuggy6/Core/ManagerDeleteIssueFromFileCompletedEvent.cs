...
// Type: MrBuggy6.Core.ManagerDeleteIssueFromFileCompletedEvent
...
{
  public delegate void ManagerDeleteIssueFromFileCompletedEvent(object sender, bool success, object tag);
}
