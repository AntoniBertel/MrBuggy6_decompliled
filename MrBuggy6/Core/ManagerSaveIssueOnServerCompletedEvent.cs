...
// Type: MrBuggy6.Core.ManagerSaveIssueOnServerCompletedEvent
...
{
  public delegate void ManagerSaveIssueOnServerCompletedEvent(object sender, bool success, object tag);
}
