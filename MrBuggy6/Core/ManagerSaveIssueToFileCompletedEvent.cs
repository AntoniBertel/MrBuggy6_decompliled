...
// Type: MrBuggy6.Core.ManagerSaveIssueToFileCompletedEvent
...
{
  public delegate void ManagerSaveIssueToFileCompletedEvent(object sender, bool success, Issue issue, object tag);
}
